package com.example.emotiondetection.ml;
...
public final class OutputModel1 {
  @NonNull
  private final Model model;

  private OutputModel1(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "output_model1.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static OutputModel1 newInstance(@NonNull Context context) throws IOException {
    return new OutputModel1(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static OutputModel1 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new OutputModel1(context, options);
  }
